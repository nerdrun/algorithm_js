...
describe('extract the first element and concat', () => {
  test('the extraction and concatation of first element of [1,2,3] is [[1],[2],[3]]', () => {
    expect(findCombos([1,2,3])).toStrictEqual([[1],[2],[3]]);
  });
});
